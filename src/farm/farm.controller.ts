...
export class FarmController {
    ...
    @ApiParam({ name: 'id', type: 'number', description: 'ID of the farm to find' })
    ...
    @ApiParam({ name: 'id', type: 'number', description: 'ID of the Producer to find it\'s farms' })
    ...
    @ApiResponse({ status: 404, description: 'Farm not found' })
    @ApiParam({ name: 'id', type: 'number', description: 'ID of the farm to update' })
    ...
    @ApiResponse({ status: 404, description: 'Farm not found' })
    @ApiParam({ name: 'id', type: 'number', description: 'ID of the Farm to delete' })
