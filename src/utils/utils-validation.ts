...
export class UtilsValidation {
    ...
    private static validateCpfOrCnpj(word, length, multipleFactorArray, multipleFactorArrayExt): boolean {
    ...
    static validateCnpjDigits(cnpj): boolean {
        return this.validateCpfOrCnpj(cnpj, 14, [5, 4, 3, 2, 9, 8, 7, 6, 5, 4, 3, 2], 6);
    }
}