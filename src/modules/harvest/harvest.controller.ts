...
export class HarvestController {
  ...
  @ApiBody({
    type: HarvestDto,
    description: 'Json structure for harvest object',
  })
  ...
  @ApiParam({
    name: 'id',
    type: 'number',
    description: 'ID of the harvest to find',
  })
  ...
  @ApiParam({
    name: 'id',
    type: 'number',
    description: 'ID of the harvest to update',
  })
  async updateHarvest(
    @Param('id') id: number,
  ...
  @ApiParam({
    name: 'id',
    type: 'number',
    description: 'ID of the harvest to delete',
  })
